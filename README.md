...
A free memory cleaner for Windows by TevDed. Live memory gauge, working-set
...
This produces a self-contained, single-file `MemoryCleanerer.exe` under
...
Memory Cleanerer doesn't pretend otherwise. It does exactly what it says on
each button, no more, and charges nothing for any of it.
